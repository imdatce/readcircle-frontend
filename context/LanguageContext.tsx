...
const translations: TranslationStructure = {
  ...
  tr: {
    ...
    selectResourcePrompt: "Eklemek istediğin kaynağı seç:",
    ...
    loginRequired: "Halka oluşturmak için giriş yapmalısın.",
    alertSelectResource: "Lütfen en az bir kaynak seç.",
    ...
    joinIntro:
      "Hoş geldin! Bu manevi halkaya katılmak için lütfen aşağıya ismini gir.",
    yourNamePlaceholder: "İsmin",
    continue: "Devam Et",
    ...
    loginIntro: "Giriş yapmak için bilgilerini gir.",
    usernameLabel: "Kullanıcı Adı",
    passwordLabel: "Şifre",
    placeholderUser: "Kullanıcı adını gir",
    placeholderPass: "Şifrenizi girin",
    loginButton: "Giriş Yap",
    loggingIn: "Giriş Yapılıyor...",
    loginFailed: "Giriş başarısız. Bilgilerini kontrol edin.",
    ...
    registerSuccess: "Kayıt başarılı! Yönlendiriliyorsun...",
    ...
    welcome: "Hoş geldin!",
    dashboardIntro: "Halkalarını yönet veya yenilerine katıl.",
    landingHeroSubtitle:
      "Toplu manevi etkinlikler düzenle, ilerlemeyi canlı takip et ve topluluğunla kolayca paylaş.",
    ...
    noCreatedYet: "Henüz bir halka oluşturmadın.",
    noCirclesYet: "Henüz bir halkaya katılmadın.",
    featuresTitle1: "Canlı Takip",
    featuresDesc1: "Kimin ne okuduğunu anlık gör.",
    featuresTitle2: "Kolay Paylaşım",
    featuresDesc2: "WhatsApp veya Telegram ile link paylaş.",
    ...
    confirmDelete: "Bu halkayı silmek istediğine emin misin?",
    confirmReset:
      "Bu halkayı sıfırlamak istediğine emin misin? Tüm okumalar silinecektir.",
    successReset: "Halka başarıyla sıfırlandı.",
    confirmLeave: "Bu halkadan ayrılmak istediğine emin misin?",
    successLeave: "Halkadan başarıyla ayrıldın.",
  ...
  ku: {
    ...
    whatsappShareText:
      "Hûn vexwendî xeleka manewî ya {name} ne!\n\nJi bo tevlîbûnê bitikînin: {link}\n\nKod: {code}",
    sessionCode: "KOD",
  ...
  fr: {
    ...
    landingSection: {
      landingHeroTitle:
        "Plateforme d’union spirituelle et de distribution des ressources",
      landingHeroSubtitle:
