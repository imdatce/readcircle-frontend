...
const translations = {
  ...
  fr: {
    ...
    resetSuccess: "Session réinitialisée avec succès ! En attente de nouveaux participants.",
    ...
    footerDesc: "Plateforme de connexion spirituelle et de distribution de ressources.",
    ...
    yourName: "Votre Nom",
    joinIntro: "Veuillez entrer votre nom et cliquer sur une ressource pour lire.",
    person: "Personne",
    part: "Partie",
    target: "Cible",
    total: "Total",
