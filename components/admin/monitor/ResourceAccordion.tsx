                      ...
                      <div className="flex flex-col items-end min-w-[200px] flex-1 md:flex-none relative">
                        <div className="flex justify-between w-full mb-2 text-xs font-bold">
                          <span className="text-blue-500">
                            {t("distributed") || "Dağıtılan"}: %{percentage}
                          </span>
                                  ...
                                  <td className="px-2 md:px-4 py-4">
                                    {item.isTaken ? (
                                      <div className="flex items-center gap-2">
                                        <div
                                          className={`w-7 h-7 rounded-full flex items-center justify-center font-bold text-[10px] text-white shadow-sm shrink-0 ${item.isCompleted ? "bg-emerald-500" : "bg-blue-500"}`}
                                        >
                                          {item.assignedToName
                                            ?.substring(0, 2)
                                            .toUpperCase()}
                                        ...
                                        <span
                                          className={`text-xs font-bold truncate max-w-[80px] md:max-w-[150px] ${item.isCompleted ? "text-emerald-700 dark:text-emerald-400" : "text-gray-700 dark:text-gray-300"}`}
                                        >
                                          {item.assignedToName}
                                        </span>
                                      </div>
