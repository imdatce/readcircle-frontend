  ...
  return (
    <div className="flex h-screen items-center justify-center bg-transparent p-4">
      <div className="bg-white dark:bg-gray-900 p-8 rounded-[2rem] shadow-xl text-center max-w-md w-full border border-red-100 dark:border-red-900/30 animate-in fade-in zoom-in-95 duration-300">
        ...
        <h2 className="text-2xl font-black text-gray-800 dark:text-white mb-2">{t("loginRequired")}</h2>
        <p className="text-gray-500 dark:text-gray-400 mb-8 font-medium">
          {t("unauthorizedAccess") || "Please log in to access this page and create a new circle."}
        </p>
        <Link href="/login" className="inline-flex w-full py-4 items-center justify-center bg-blue-600 text-white rounded-2xl font-bold hover:bg-blue-700 transition-all active:scale-95 shadow-lg shadow-blue-500/30">
          {t("getStarted")}
        </Link>
      </div>
    </div>
