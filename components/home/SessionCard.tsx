            ...
            <div className="flex items-center justify-between gap-2">
              <div className="flex bg-gray-50 dark:bg-gray-800/80 rounded-xl p-1 border border-gray-100 dark:border-gray-700/50 shadow-inner">
                ...
                <button
                  ...
                  className="px-2.5 py-1.5 rounded-lg text-[#25D366] hover:bg-[#25D366] hover:text-white dark:hover:bg-[#25D366] transition-all flex items-center justify-center"
                  title={t("shareWhatsapp") || "WhatsApp"}
                >
                  <svg
