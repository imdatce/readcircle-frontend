              ...
              return (
                <div key={lang}>
                  <button
                    ...
                    className={`
                      w-full text-left px-4 py-3 text-sm font-medium flex items-center gap-3 transition hover:bg-gray-50
                      ${isActive ? "text-emerald-600 bg-emerald-50/50" : "text-gray-700"}
                    `}
                  >
                    {config.icon}
                    {config.label}
